...
**统计认证：FAIL ❌ — 未通过**（部署对象 = donchian 参数集成×3 币组合：DSR(N=4 族选择)=0.868, DSR(N=32 组合级参数×族)=0.395，要求两者均 ≥0.95）
...
|---|---|---|---|---|---|---|---|
| sma_cross | 0.64 | 18.6 | 38.2 | -36.0 | 1414 | 0.817 | 0.321 |
| donchian | 0.74 | 19.6 | 30.5 | -28.4 | 1414 | 0.868 | 0.395 |
| tsmom | 0.65 | 6.0 | 9.8 | -12.2 | 1414 | 0.824 | 0.33 |
| rsi_meanrev | 0.35 | 6.3 | 30.7 | -38.1 | 1414 | 0.634 | 0.15 |
...
1. **两级判定**：研究候选通过（BTCUSDT, ETHUSDT, SOLUSDT 现货 donchian，族内 DSR 0.96–0.98）；**统计认证未通过**——部署组合 DSR(N=4)=0.868、DSR(N=32)=0.395，低于 0.95 门槛。
